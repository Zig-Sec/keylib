...
pub fn getCredentialPublicKey(
    self: *const @This(),
    allocator: std.mem.Allocator,
) !cbor.cose.Key {
    if (self.attestedCredentialData == null) return error.NoAttestedCredentialData;
